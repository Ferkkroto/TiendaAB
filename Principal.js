...
function mostrarElemtrosLista() {
    ...
    for (let i = 0; i < lista.length; i++){
        productosCompra.innerHTML += `<div><div class="img"><button onclick=eliminar(${i}) class="botonEliminar"><img src="Imagenes/eliminar.jpg"></button><p>${lista[i].nombre}</p></div><p> $${lista[i].precio}</p></div>`
...
comprarButton.addEventListener('click', function() {
    // Redirecciona a la página MetodoPago.html
